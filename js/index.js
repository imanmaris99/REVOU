...
let resultArea = document.querySelector(".comment2");
...
document.querySelector(".comment2").innerHTML = `You are <span id="comment2">${result}</span>`;
document.querySelector("#hasil-nilai").innerHTML = bmi.toFixed(2);
